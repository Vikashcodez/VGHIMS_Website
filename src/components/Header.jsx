...
const Header = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 sm:px-8">
          <div className="flex justify-between items-center max-w-7xl mx-auto">
            ...
            <button 
              ...
              className="lg:hidden z-[70] p-2 bg-white rounded-md shadow-md transition-all duration-300 relative"
              aria-label="Toggle menu"
            >
              <div className="w-6 h-5 flex flex-col justify-between">
                <span className={`h-0.5 w-full bg-gray-700 transition-all duration-300 ${
                  isMobileMenuOpen 
      ...
      {/* Mobile Menu - Completely separate with solid background */}
      <div 
      ...
      >
        ...
        <button 
          onClick={() => setIsMobileMenuOpen(false)}
          className="absolute top-6 right-6 z-[70] p-2 bg-white rounded-md shadow-md"
          aria-label="Close menu"
        >
          <div className="w-6 h-5 flex flex-col justify-center items-center">
            <span className="h-0.5 w-full bg-gray-700 rotate-45 absolute"></span>
            <span className="h-0.5 w-full bg-gray-700 -rotate-45 absolute"></span>
          </div>
        </button>
